...
> **Superseded (same day):** not this one either — CI on this tag's bytes went
> red on two hot-tree desyncs (the plugin-skills sync pin and the new
> canonical-example lockstep gate), so the ci-green witness gate refused the
> upload again. The v0.23.x line re-cut as [v0.23.3](v0.23.3.md).
